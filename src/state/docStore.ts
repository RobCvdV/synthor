...
import type { Doc, Id, ModuleType, Pattern } from '../domain/types'
...
export interface DocState extends CoreOps, TrackerOps, TrackOps, InstrumentOps, ModularOps, SampleOps, DrumkitOps {
  doc: Doc
  past: HistoryEntry[]
  future: HistoryEntry[]
