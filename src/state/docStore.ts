...
import type { Connection, Doc, DrumKitSlot, Id, Module, ModuleType, Pattern, Port, SampleEntity } from '../domain/types'
...
export interface DocState extends CoreOps, TrackerOps, TrackOps, InstrumentOps {
  doc: Doc
  past: HistoryEntry[]
  future: HistoryEntry[]
