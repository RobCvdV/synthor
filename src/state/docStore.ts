...
import type { Connection, Doc, DrumKitSlot, Id, Instrument, Module, ModuleType, Pattern, Port, SampleEntity } from '../domain/types'
...
export interface DocState extends CoreOps, TrackerOps, TrackOps {
  doc: Doc
  past: HistoryEntry[]
  future: HistoryEntry[]
